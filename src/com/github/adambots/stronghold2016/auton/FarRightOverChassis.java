...
public class FarRightOverChassis extends Command {
	...
	public FarRightOverChassis(String name) {
		super(name);
		turnamountL = 40;
		turnamountR = 40;
		driveDistance = -48;
	...
	public FarRightOverChassis(double timeout) {
		super(timeout);
		turnamountL = 40;
		turnamountR = 40;
		driveDistance = -48;
	...
	public FarRightOverChassis(String name, double timeout) {
		super(name, timeout);
		turnamountL = 40;
		turnamountR = 40;
		driveDistance = -48;
	...
	protected void execute() {
		...
		if (!turned) {
			...
			Drive.driveWithPID(driveDistance*2, driveDistance*2);
