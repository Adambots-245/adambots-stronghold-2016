...
public class SuperRightOverChassis extends Command {
	...
	public SuperRightOverChassis(String name) {
		super(name);
		turnamountL = 40;
		turnamountR = 40;
		driveDistance = -48;
	...
	public SuperRightOverChassis(double timeout) {
		super(timeout);
		turnamountL = 40;
		turnamountR = 40;
		driveDistance = -48;
	...
	public SuperRightOverChassis(String name, double timeout) {
		super(name, timeout);
		turnamountL = 40;
		turnamountR = 40;
		driveDistance = -48;
	...
	protected void execute() {
		...
		if (!turned) {
			...
			Drive.driveWithPID(driveDistance*3, driveDistance*3);
